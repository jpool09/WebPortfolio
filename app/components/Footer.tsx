...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="py-12 bg-gray-900/50 border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              Software Engineer specializing in Web3 and AI technologies. Always open to new opportunities and collaborations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/resume" className="text-gray-400 hover:text-cyan-400 transition-colors">
                  Resume
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-3 text-gray-400">
                ...
                <a href="mailto:cruzonchain@gmail.com" className="hover:text-cyan-400 transition-colors">
                  cruzonchain@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-3 text-gray-400">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © {currentYear} Jean Pool Cruz. All rights reserved.
          </p>
